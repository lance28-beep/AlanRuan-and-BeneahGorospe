...
export function WeddingTimeline() {
  return (
    <Section
      id="wedding-timeline"
      className="relative py-10 sm:py-14 md:py-18 lg:py-20 overflow-hidden "
    >
      {/* Background glows */}
      ...
      <div className="relative z-10 text-center mb-6 sm:mb-9 md:mb-12 px-3 sm:px-4">
        {/* Small label */}
        <p
          className={`${montserrat.className} text-[0.7rem] sm:text-xs md:text-sm tracking-[0.3em] uppercase text-[#FDEFD0] mb-2`}
        >
          Day Schedule
        </p>

        <h2
          className={`${montserrat.className} text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-[#FEF7DB] mb-1.5 sm:mb-3 md:mb-4 uppercase`}
        ...
        <p
          className={`${montserrat.className} text-[11px] sm:text-sm md:text-base lg:text-lg text-[#FDEFD0] max-w-xl mx-auto leading-relaxed px-2`}
        >
        ...
        <div className="flex items-center justify-center gap-2 mt-3 sm:mt-4">
          ...
          <div className="w-1.5 h-1.5 bg-[#F3C66C]/80 rounded-full" />
          <div className="w-1.5 h-1.5 bg-[#F3C66C] rounded-full" />
          <div className="w-8 sm:w-12 md:w-16 h-px bg-[#F3C66C]/45" />
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-3 sm:px-5 lg:px-8">
        ...
        <div className="hidden md:block absolute left-[4rem] md:left-[5rem] lg:left-[6rem] top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#F3C66C]/30 via-[#F3C66C]/55 to-[#F3C66C]/30 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[#F3C66C]" />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[#F3C66C]" />
        </div>

        {/* Mobile timeline line */}
        <div className="md:hidden absolute left-10 sm:left-11 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#F3C66C]/35 via-[#F3C66C]/60 to-[#F3C66C]/35 pointer-events-none" />
...
function TimelineCard({ event, Icon, mobile }: { event: TimelineEvent; Icon: TimelineIcon; mobile?: boolean }) {
  return (
    <div
      className={`rounded-lg sm:rounded-xl border border-[#E0C5A2] bg-[#FDF6EA]/95 backdrop-blur-sm shadow-[0_10px_26px_rgba(0,0,0,0.45)] hover:shadow-[0_14px_32px_rgba(0,0,0,0.6)] transition-all duration-300 ${
    ...
    >
      <div className={`${mobile ? "space-y-2" : "space-y-3 md:space-y-4"}`}>
        ...
        <div className="flex items-center gap-1.5">
          <Clock
            className={`${mobile ? "w-3.5 h-3.5" : "w-4 h-4 md:w-5 md:h-5"} text-[#8B1E1E] flex-shrink-0`}
          />
          <p
            className={`${montserrat.className} ${
              mobile ? "text-[10px]" : "text-xs sm:text-sm md:text-base"
            } font-semibold tracking-[0.18em] text-[#8B1E1E] uppercase`}
          >
            {event.time}
          </p>
        </div>
        ...
        <h3
          className={`${montserrat.className} ${
            mobile ? "text-sm sm:text-base" : "text-base sm:text-lg md:text-xl lg:text-2xl"
          } font-semibold text-[#3C2A25] leading-tight`}
        >
          {event.title}
        </h3>
        ...
        {event.description && (
          <p
            className={`${
              mobile ? "text-[10px] sm:text-xs" : "text-xs sm:text-sm md:text-base"
            } text-[#5A3A32] leading-relaxed`}
          >
            {event.description}
          </p>
        )}
        ...
        {event.location && (
          ...
          >
            <MapPin
              className={`${mobile ? "w-3 h-3" : "w-3.5 h-3.5 md:w-4 md:h-4"} text-[#8B1E1E] mt-0.5 flex-shrink-0`}
            />
            <p
              className={`${mobile ? "text-[10px]" : "text-xs md:text-sm"} text-[#5A3A32] leading-relaxed`}
            >
              {event.location}
            </p>
          </div>
...
function IconBadge({
  ...
  return (
    <div
      ...
      } rounded-full border-2 border-[#F3C66C]/80 bg-[#FDF6EA] flex items-center justify-center shadow-[0_10px_26px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform duration-300`}
    >
      <Icon
        className={`${
